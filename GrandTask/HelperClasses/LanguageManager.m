...
static NSString * const LanguageCodes[] = { @"en", @"ar", @"de", @"fr" };
static NSString * const LanguageStrings[] = { @"English",@"Arabic",@"German", @"French" };
...
//    [[NSUserDefaults standardUserDefaults] synchronize];
    [NSBundle setLanguageForViewsLocalization:currentLanguage];
}
...
//#ifdef USE_ON_FLY_LOCALIZATION
        [NSBundle setLanguageForViewsLocalization:code];
//#endif
    }
}
